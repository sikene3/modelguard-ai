...
TLS-only S3 state bucket; native S3 lockfile permissions; the GitHub OIDC provider; exact-subject CI
plan/deploy roles; scoped retained CI read/compute/data/operations policies and attachments; and the
mandatory workload permission boundary.
